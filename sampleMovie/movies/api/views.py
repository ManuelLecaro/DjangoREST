...
from movies.models import TipoPlan, Plan, Peliculas, Persona, Log, RatingPeliculas
from movies.api.serializers import TipoPlanSerializer, PlanSerializer, PeliculasSerializer, PersonaSerializer, LogSerializer, RatingSerializer
